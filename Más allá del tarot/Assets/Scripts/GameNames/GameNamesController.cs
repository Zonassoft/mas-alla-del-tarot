...
public class GameNamesController : MonoBehaviour
{
...
//    }
    ...
    {
        GameObject newLetter2 = Instantiate(LettersList[pos], layoutName2.transform.position, layoutName2.transform.rotation);
        newLetter2.transform.SetParent(layoutName2.transform);
    }

    public void ButtonSex()
    {
        buttonSex.gameObject.GetComponent<Animation>().Play("Voltear");
    ...
    public IEnumerator TurnCard()
    {
        ...
        {
            sexFemale = false;
            ImgFemale.SetActive(false);
            ImgMale.SetActive(true);
            textFemale.gameObject.SetActive(false);
            texMale.gameObject.SetActive(true);
        }
        else
        {
            sexFemale = true;
            ImgMale.SetActive(false);
            ImgFemale.SetActive(true);
            texMale.gameObject.SetActive(false);
            textFemale.gameObject.SetActive(true);
        }
    }
